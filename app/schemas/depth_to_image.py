...
class DepthToImageRequest(BaseRequestModel):
    """
    A Pydantic model representing a request for a depth-to-image transformation.
    ...
    Attributes:
        ...
        guidance_scale (Optional[float]): The unconditional guidance scale for the transformation.
            Defaults to 7.5.
        strength (Optional[float]): The strength of the transformation. Must be between 0 and 1. Defaults to 0.7.
    ...
    def as_form(
        ...
        strength: Optional[float] = Form(
            ...
            "A value of 1, therefore, essentially ignores images.",
        ),
